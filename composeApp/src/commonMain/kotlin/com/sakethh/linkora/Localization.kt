...
object Localization {
        ...
        Key.entries.forEach { key ->
            localizedStrings[key.name] =
                if (languageCode == Constants.DEFAULT_APP_LANGUAGE_CODE || forceLoadDefaultValues) {
                    ...
                    DependencyContainer.localizationRepo
                        .getLocalizedStringValueFor(
                            key.name,
                            languageCode,
                        )
                        .run {
    ...
    @Composable
    fun rememberLocalizedString(key: Key): String = remember {
        derivedStateOf {
    ...
    enum class Key(val defaultValue: String) {
        ...
        EnforceStrictDefaultIDsDesc(
            "Force writes the IDs of Saved Links, Important Links, Archived Links, History Links to its internal IDs respectively.\n\nThis operation is usually not required, since linkora handles it by default.",
        ),
        ...
        AppIntroSlide3MainLabelDesc(
            "Add any folder to a Panel for quick access from the Home screen. Panels work like tags but for folders. You can group different folders under each one and access them instantly.\nOh, and yep — Linkora supports subfolders too.",
        ),
        ...
        AppIntroSlide4Label2Desc(
            "Linkora and its related projects, including the sync-server, are released as free and open-source software under their respective licenses.",
        ),
        ...
        RetryingWithSecondaryUserAgent(
            defaultValue = "Retrying metadata retrieval using a secondary user agent.",
        ),
        ...
        UseCustomAppVersionDesc(
            defaultValue = "Enables a custom font-based version label throughout the app.",
        ),
        UseInAppBrowserDesc(
            defaultValue =
        ...
        ImportDataFromHtmlFileDesc(defaultValue = "Load data from a bookmarks-compatible HTML file"),
        ...
        RefreshAllLinksTitlesAndImagesDesc(
            defaultValue = "Manually entered titles will be replaced with detected titles.",
        ),
        ...
        ChangeInitialRouteDesc(
            "Changing the initial route lets you set which screen opens first when the app launches.",
        ),
        ...
        UseDynamicThemingDesc(
            defaultValue = "Automatically sync the app's color theme with your wallpaper.",
        ),
        ...
        FolderHasBeenCreatedSuccessful(
            defaultValue = "The folder ${LinkoraPlaceHolder.First.value} has been successfully created.",
        ),
        ...
        DownloadedLanguageStrings(
            defaultValue = "Downloaded Language Strings for the ${LinkoraPlaceHolder.First.value}.",
        ),
        ...
        AreYouSureDeleteSelectedLinks(
            defaultValue = "Are you sure you want to delete all selected links?",
        ),
        AreYouSureDeleteLink(defaultValue = "Are you sure you want to delete the link?"),
        AreYouSureDeleteSelectedFolders(
            defaultValue = "Are you sure you want to delete all selected folders?",
        ),
        AreYouSureDeleteFolder(defaultValue = "Are you sure you want to delete the folder?"),
        AreYouSureDeleteSelectedItems(
            defaultValue = "Are you sure you want to delete all selected items?",
        ),
        ...
        ArchivedTheFolder(
            defaultValue = "The folder ${LinkoraPlaceHolder.First.value} has been archived.",
        ),
        UnArchivedTheFolder(
        ...
        LatestVersionAvailableDesc(
            defaultValue = "a new ${LinkoraPlaceHolder.First.value} build has been released",
        ),
        ...
        RetrievingLatestInformation(
            defaultValue = "Retrieving latest information, this may take sometime.",
        ),
        ...
        ForceShuffleLinksDesc(
            "Forces a randomized link order, overriding the sorting type above. This applies only to links, not folders.",
        ),
        ...
        SerializingCollectedDataForExport(
            defaultValue = "Serializing the collected data for export...",
        ),
        ...
        NoFoldersOrLinksFound(defaultValue = "Nothing here yet. Add folders or links to begin."),
        ...
        ExportingDataToJSON(defaultValue = "Exporting Data to JSON..."),
        ...
        NoLinksFound(defaultValue = "No links available. Start by adding a few."),
        ...
        NoSearchResults(defaultValue = "No results found."),
        ...
        DataSynchronizationCompletedSuccessfully(
            defaultValue = "Data synchronization completed successfully.",
        ),
        ...
        RemoteDataDeletionFailure(
            defaultValue = "The data from the remote database could not be deleted.",
        ),
        ...
        ImportMethodLabel(defaultValue = "Import Method : "),
        ...
        AutoSavingTheLinkNotifyDesc(
            "Retrieving metadata to save the link: ${LinkoraPlaceHolder.First}",
        ),
        ...
        RefreshLinksComponentDesc(
            "Using a high number of concurrent refreshes may significantly impact your resources and consume more than usual.",
        ),
        ...
        SyncServerConfigurationError(
            "syncServerClient isn't configured; make sure a valid certificate is imported.",
        ),
        ...
        AutoSaveLinksDesc(
            "Auto-saved links will be added to \"Saved Links\" without tags, and their title and image will be fetched automatically.",
        ),
