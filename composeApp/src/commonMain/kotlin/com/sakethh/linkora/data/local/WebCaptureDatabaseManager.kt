...
// to get around that, we will only create the database when the user opts-in to the feature for the
// first time.
// for the current custom DI setup, this lazy approach is the simplest way to implement this without
// blowing things up.
