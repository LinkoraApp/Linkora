...
class UtilsTest {
    ...
    fun `html parsing should return valid meta info`() = runTest {
        ...
        listOf(
            ...
            "https://discuss.kotlinlang.org/t/how-to-best-use-mockito-in-kotlin/24675" to
                ScrapedLinkInfo(
                    title = "How to best use Mockito in Kotlin?",
                    imgUrl =
                    "https://us1.discourse-cdn.com/flex019/uploads/kotlinlang/original/2X/2/224964e73572d20c3aa9d68b4c14ae5d11749202.png",
                ),
            "https://tidal.com/artist/4143898" to
                ScrapedLinkInfo(
                    title = "Nujabes",
                    imgUrl =
                    "https://resources.tidal.com/images/f899da08/195b/432d/b17c/207ffb009380/750x750.jpg",
                ),
            "https://genius.com/albums/Nujabes/Modal-soul" to
                ScrapedLinkInfo(
                    title = "Modal Soul by Nujabes",
                    imgUrl =
                    "https://images.genius.com/7f62b49d9becfdf686ce707a1e77a841.873x873x1.png",
                ),
        )
